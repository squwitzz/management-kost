<?php
/**
 * Reset User Password Helper - Simple Version
 * 
...
if (!file_exists($vendorPath)) {
    die('Error: vendor/autoload.php not found. Make sure composer install has been run.');
}
...
<body>
    <div class="container">
        ...
        <div class="warning">
            ...
            <br><br>
            File location: <code>/public/reset-password.php</code>
        </div>
    </div>
</body>
</html>
